...
var muro_primopiano_trasl = T([1,2,3])([11,0.5,2.5+0.39])(muro_sotto_fin);

//muro tra le 2 finestre
var muro_in_fin = CUBOID([0.25,1.58,1.23]);
var mif_trasl = T([1,2,3])([11,0.5,1.66+2.5])(muro_in_fin);

//muro secondo piano
var muro_secpiano_trasl2 = T([1,2,3])([11,0.5,(2.5+0.39)*2])(muro_sotto_fin);

//muro tra le 2 finestre
var mif_trasl2 = T([1,2,3])([11,0.5,1.66+2.5*2+0.39])(muro_in_fin);

//muro terzo piano
var muro_terpiano_trasl3 = T([1,2,3])([11,0.5,(2.5+0.39)*3])(muro_sotto_fin);

//muro tra le 2 finestre
var mif_trasl3 = T([1,2,3])([11,0.5,1.66+2.5*3+0.78])(muro_in_fin);
